...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        if (passenger['Sex'] == "female" or passenger['Sex'] == "male") and passenger['Pclass'] == 1 and passenger['Age'] < 18:
            passenger_id = passenger['PassengerId']
            predictions[passenger_id] = 1
        elif passenger['Sex'] == "female" or (passenger['Pclass'] == 2 and passenger['Age'] < 5):
                passenger_id = passenger['PassengerId']
                predictions[passenger_id] = 1
